...
namespace Jogo25D.Scripts.Actions
{
    public class FireballAction : PlayerAction
    {
        ...
        public Item Characteristics { get; set; } = new Item("Fireball", ItemType.WeaponRanged);
        ...
        public FireballAction(Player player) : base(player)
        {
            ...
            Characteristics.ProjectileScene = GD.Load<PackedScene>("res://Scenes/World/Projectiles/Fireball.tscn");
            weapon = CombatFactory.Use(Characteristics, player);
